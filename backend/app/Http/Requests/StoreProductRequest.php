...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sale_price' => 'nullable|numeric|min:0|lt:price|max:9999999.99',
    ...
    public function messages(): array
    {
        return [
            ...
            'sale_price.numeric' => 'Le prix soldé doit être un nombre.',
            'sale_price.min' => 'Le prix soldé ne peut pas être négatif.',
            'sale_price.lt' => 'Le prix soldé doit être inférieur au prix normal.',
            'sale_price.max' => 'Le prix soldé ne peut pas dépasser 9 999 999,99.',
