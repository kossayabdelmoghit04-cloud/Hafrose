...
- Name: admin-auth.spec.ts >> Admin & Customer Auth - Complete E2E Chain >> Step 4: Unauthenticated access to /admin is blocked by ProtectedRoute
- Location: e2e\admin-auth.spec.ts:72:3
