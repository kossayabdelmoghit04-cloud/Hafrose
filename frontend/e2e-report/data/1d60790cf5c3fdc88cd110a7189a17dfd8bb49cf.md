...
- Name: account_icon_navigation.spec.ts >> Icône 👤 Mon Compte — Navigation conditionnelle (React Router Link) >> TEST 1 — Utilisateur non authentifié : clic icône compte → /login sans reload inattendu
- Location: e2e\account_icon_navigation.spec.ts:5:3
