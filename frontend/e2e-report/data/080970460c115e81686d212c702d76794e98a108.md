...
- Name: auth_customer_journey.spec.ts >> Customer Authentication and Account Journey >> TEST 2: Visitor clicks Mon Compte icon in Header -> redirects to /login
- Location: e2e\auth_customer_journey.spec.ts:25:3
