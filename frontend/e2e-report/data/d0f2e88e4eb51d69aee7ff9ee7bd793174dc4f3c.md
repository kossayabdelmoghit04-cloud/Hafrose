...
- Name: admin-auth.spec.ts >> Admin & Customer Auth - Complete E2E Chain >> Step 2: Login form submits correctly and reaches dashboard
- Location: e2e\admin-auth.spec.ts:25:3
