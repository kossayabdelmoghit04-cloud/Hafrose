...
- Name: account_icon_navigation.spec.ts >> Icône 👤 Mon Compte — Navigation conditionnelle (React Router Link) >> TEST 5 — Menu Mobile : visiteur non connecté clic Mon Compte → /login
- Location: e2e\account_icon_navigation.spec.ts:99:3
