...
- Name: account_icon_navigation.spec.ts >> Icône 👤 Mon Compte — Navigation conditionnelle (React Router Link) >> TEST 4 — Absence de boucle de redirection sur /login
- Location: e2e\account_icon_navigation.spec.ts:79:3
