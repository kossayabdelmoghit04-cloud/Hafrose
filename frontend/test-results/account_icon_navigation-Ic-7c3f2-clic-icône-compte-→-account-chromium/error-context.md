...
- Name: account_icon_navigation.spec.ts >> Icône 👤 Mon Compte — Navigation conditionnelle (React Router Link) >> TEST 2 — Utilisateur authentifié : clic icône compte → /account
- Location: e2e\account_icon_navigation.spec.ts:44:3
