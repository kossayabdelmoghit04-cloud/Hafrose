...
- Name: admin-auth.spec.ts >> Admin & Customer Auth - Complete E2E Chain >> Step 5: Error handling on wrong credentials
- Location: e2e\admin-auth.spec.ts:89:3
...
- button "Afficher le mot de passe":
  - img
- button "Chargement en cours... Accéder au Panneau Admin" [disabled]:
  - status "Chargement en cours..."
  - text: Accéder au Panneau Admin
- paragraph: © 2026 HAFROSE — Maison de Luxe. Accès sécurisé.
```
